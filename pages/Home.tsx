...
const Home: React.FC<HomeProps> = ({ data }) => {
  ...
  return (
    <div className="space-y-24 pb-32">
      {/* Hero Section */}
      <section className="relative px-4 sm:px-8 lg:px-16 py-12 sm:py-20 lg:py-32 overflow-hidden mt-0">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12">
          <div className="flex-1 text-center lg:text-left z-10">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black text-white tracking-tighter leading-none mb-8 animate-in fade-in duration-700">
            ...
            <p className="text-base sm:text-lg lg:text-lg text-slate-400 max-w-lg mb-12 leading-relaxed animate-in fade-in slide-in-from-left-8 duration-900" style={{ animationDelay: '0.6s' }}>
              {data.settings.bio}
            </p>
            <div className="w-full flex flex-col sm:flex-row gap-3 sm:gap-6 animate-in fade-in slide-in-from-left-10 duration-1000">
              <a href="#" className="px-6 sm:px-10 py-3 sm:py-5 bg-blue-600 text-white font-bold text-sm sm:text-base rounded-2xl shadow-xl shadow-blue-900/40 hover:bg-blue-500 transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center whitespace-nowrap">
                Download CV
              </a>
              <a href="#/contact" className="px-6 sm:px-10 py-3 sm:py-5 bg-slate-900 text-white font-bold text-sm sm:text-base border border-slate-800 rounded-2xl hover:bg-slate-800 transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center whitespace-nowrap">
                Let's Talk
              </a>
            </div>
          </div>
      ...
      <section className="px-4 sm:px-8 lg:px-16">
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-blue-700 to-indigo-900 rounded-2xl sm:rounded-3xl p-8 sm:p-12 lg:p-16 text-center relative overflow-hidden group">
            <div className="relative z-10">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-4 sm:mb-6 tracking-tighter leading-tight">Ready to collaborate?</h2>
              <p className="text-blue-100 text-sm sm:text-base mb-8 sm:mb-10 max-w-xl mx-auto opacity-80 leading-relaxed">
                Let's create something exceptional together. Get in touch to discuss your project.
              </p>
              <a href="#/contact" className="inline-flex items-center px-6 sm:px-10 py-3 sm:py-4 bg-white text-blue-700 font-bold text-sm sm:text-base rounded-xl hover:bg-blue-50 transition-all duration-300 shadow-xl transform hover:scale-105 active:scale-95">
