    ...
    <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 py-20 space-y-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start lg:items-center">
        <div className="order-2 lg:order-1 space-y-8">
          ...
          <div className="space-y-5 text-base lg:text-lg text-slate-400 leading-relaxed font-medium">
            <p className="text-slate-200 font-semibold text-lg border-l-4 border-blue-500 pl-5 bg-blue-500/5 py-3 rounded-r-2xl">
              {data.settings.bio}
            </p>
            <p>
          ...
          <div className="pt-8 flex flex-wrap gap-6">
            <a 
              ...
              className="px-8 py-4 bg-slate-900 rounded-2xl border border-slate-800 text-white hover:border-blue-500 hover:text-blue-500 transition-all shadow-xl hover:shadow-blue-500/10 flex items-center group"
            >
              <svg className="h-6 w-6 mr-3" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.041-1.416-4.041-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
              View GitHub
            </a>
            <a 
              ...
              className="px-8 py-4 bg-slate-900 rounded-2xl border border-slate-800 text-white hover:border-blue-500 hover:text-blue-500 transition-all shadow-xl hover:shadow-blue-500/10 flex items-center group"
            >
              <svg className="h-6 w-6 mr-3" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              LinkedIn Profile
            </a>
          </div>
        </div>
      ...
      <section className="space-y-16">
        <div className="text-center max-w-2xl mx-auto space-y-4">
          ...
          <h2 className="text-4xl lg:text-6xl font-black text-white tracking-tighter">My Technical Stack<span className="text-blue-500">.</span></h2>
      ...
      {/* Final CTA in About */}
      <div className="bg-slate-900 border border-slate-800 rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden group">
        <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500/10 rounded-full blur-[100px] -mr-20 -mt-20"></div>
        <div className="relative z-10 space-y-8">
          <h2 className="text-4xl lg:text-5xl font-black text-white tracking-tighter">Let's build something together.</h2>
          ...
          <a href="#/contact" className="inline-block px-12 py-5 bg-blue-600 text-white font-bold rounded-2xl hover:bg-blue-500 transition-all shadow-xl shadow-blue-500/20 transform hover:scale-105 active:scale-95">
            Get In Touch
          </a>
        </div>
      </div>
