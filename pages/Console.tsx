...
const Console: React.FC<ConsoleProps> = ({ data }) => {
  ...
  const handleDeploy = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Deploying asset:', formData);
    // Reset form
    setFormData({
      title: '',
      description: '',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-3xl p-8 space-y-6">
            ...
            <form onSubmit={handleDeploy} className="space-y-4">
              ...
              <button 
                type="submit"
                className="w-full px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-900/40 transform hover:scale-105 active:scale-95 mt-6"
              >
                Deploy Asset
              </button>
            </form>
